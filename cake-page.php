...
<head>
  ...
  <title>Final Year Project - Cake Menu Page</title>
	  ...
	  <section class="cake-page">
        <div class="container">
		  ...
		  <!-- Display all Food from food table --> 
		    <?php
		    $sql = "SELECT * FROM product WHERE product_category_id =1 AND product_status='AVAILABLE'";
		...
		?>
			    <div class="col-md-6 col-lg-6"> 
			      <form method="post" action="cake-page.php?action=add&prodid=<?php echo $row['product_id'];?>">

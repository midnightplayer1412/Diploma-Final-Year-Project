  ...
  <!-- ======= Header ======= -->
	...
	<main id="main">
		...
		<section class="inner-page">
			<div class="container">
				<div id='forget-form'class='reset-page'>
					<div class="form-box-forget">
					<h6>Forget Password</h6>
					<p>Please enter your email. You will receive an email to reset the password</p>
						<form action="mailto.php" id='login' class='input-group-reset' method="post">
							<input type="email" class="input-field" name="getEmail" placeholder="Enter Email" style="margin-top: 50px;">
							<input type='submit'class='submit-btn' name="emailbtn" value="Reset My Password" style="color:black;">
						</form>
					</div>
				</div>
